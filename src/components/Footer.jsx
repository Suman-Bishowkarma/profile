  ...
  return (
    <footer className="bg-primary border-t border-secondary/20">
      <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-secondary text-sm">{personalInfo.title}</p>
              </div>
            </div>
            <p className="text-secondary text-center lg:text-left max-w-md">
            ...
            <div className="flex gap-6">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="text-secondary hover:text-white transition-colors duration-300 p-3 rounded-full border border-secondary/20 hover:border-white/20 hover:bg-tertiary/10"
        ...
        {/* Divider */}
        <motion.div
          className="border-t border-secondary/20 mt-12 pt-8"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-secondary text-sm text-center md:text-right">
